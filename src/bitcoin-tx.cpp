...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s jagaricoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  jagaricoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded jagaricoin transaction") + "\n" +
              "  jagaricoin-tx [options] -create [commands]   " + _("Create hex-encoded jagaricoin transaction") + "\n" +
              "\n";
