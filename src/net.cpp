...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Jagaricoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"dnsseed.jagaricoin.tk", "main-net.jagaricoin.tk"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"dnsseed.jagaricoin.tk", "test-net.jagaricoin.tk"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Jagaricoin is probably already running."), addrBind.ToString().c_str());
        else
