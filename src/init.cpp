...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/jagaricoin-project/jagaricoin>";
    const std::string URL_WEBSITE = "<https://www.jagaricoin.tk>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Jagaricoin version %s\n", FormatFullVersion());
}
